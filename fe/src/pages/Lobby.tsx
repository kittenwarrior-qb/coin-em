      ...
      <AnimatePresence mode="wait">
        {screen === 'menu' && (
          <motion.div
            ...
            className="w-full max-w-sm mx-auto rounded-3xl border-4 border-black bg-white p-8 flex flex-col gap-4"
          >
        ...
        {screen === 'join' && (
          <motion.div
            ...
            exit={{ opacity: 0, x: -20 }}
            className="w-full max-w-sm mx-auto rounded-3xl border-4 border-black bg-white p-8 flex flex-col gap-5"
          >
