...
export const PHASE_LABELS: Record<GamePhase, string> = {
  ...
  'night':              'Đêm bắt đầu',
  'healer-turn':        'Lượt Người Chữa Lành',
  'silencer-turn':      'Lượt Người Im Lặng',
  'situation-card':     'Chọn thẻ Tình huống',
